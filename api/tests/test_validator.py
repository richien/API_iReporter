...
class TestValidate(unittest.TestCase):
    ...
    def test_validate_incident_post_request_with_invalid_request_data(self):
        ...
        self.assertIn("Invalid request body - error in request body", is_valid['message']['error'])

    def test_validate_signin_details_with_username_and_valid_request_data(self):
    ...
    def test_validate_signin_details_with_username_and_invalid_request_data(self):
    ...
    def test_validate_signin_details_without_password_in_request_data(self):
        ...
        self.assertFalse(is_valid['is_valid'])
        self.assertEqual(400, is_valid['message']['status'])
        self.assertIn("error in request body, missing required field 'password", is_valid['message']['error'])
    ...
    def test_validate_signup_details_with_invalid_password_in_request_data(self):
        ...
        self.assertFalse(is_valid['is_valid'])
        self.assertEqual(400, is_valid['message']['status'])
        self.assertIn("Password cannot be less than 8 characters", is_valid['message']['error'])

    def test_validate_signup_details_with_valid_request_data_and_without_othernames_field(self):
    ...
    def test_validate_signup_details_with_valid_request_data_and_without_phonenumber_field(self):
    ...
    def test_validate_signup_details_with_valid_request_data_and_without_isAdmin_field(self):
